void ttbar(){
  ...
  TH1F *hist_lep_pt = new TH1F("Leptons p_{T}","Leptons p_{T}; Lep p_{T}; Events",20,1000,1000000);
  TH1F *hist_lep_pt30 = new TH1F("Track isolation","Track isolation; Lep_ptcone30/Lep_pt; Events",20,0,1);
  TH1F *hist_lep_et20 = new TH1F("Calorimeter isolation","Calorimeter isolation; Lep_etcone20/Lep_pt; Events",20,-1,1);
  TH1F *hist_lep_eta = new TH1F("Leptons #eta","Leptons #eta; #eta; Events",20,-4,4);
  TH1F *hist_njets = new TH1F("n-jets","Number of jets; Jet multiplicity; Events",10,0,10);
  TH1F *hist_jets_pt = new TH1F("Jets p_{T}","Jets p_{T}; Jets p_{T}; Events",20,0,1000000);
  TH1F *hist_jets_eta = new TH1F("Jets #eta","Jets #eta; #eta; Events",20,-4,4);
  TH1F *hist_jets_JVF = new TH1F("Jets JVF","JVF; Jets JVF; Events",50,0,1);
  TH1F *hist_jets_MV1 = new TH1F("Jets MV1","MV1; Jets MV1; Events",10,0,1);
  TH1F *hist_bjets = new TH1F("b-jets","Number of bjets; n_bjets; Events",200,0,10);
